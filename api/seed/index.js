...
async function main () {
  try {
    const mclient = new MongoClient('mongodb://localhost', { useNewUrlParser: true });
    ...
    const items = _.range(10000).map(i => random_row());
