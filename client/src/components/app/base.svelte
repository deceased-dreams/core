<script type="text/javascript">
  import logo from 'dinastry/icons/hexagon.svg';
</script>

<div class="app flex flex-col" style="min-height: 100vh;">
  <nav class="h-16 bg-gray-900 text-white flex items-center px-12">
